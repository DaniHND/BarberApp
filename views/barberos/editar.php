...
<div class="max-w-lg">
    ...
    <div class="flex items-center gap-2 text-xs text-zinc-400 mb-5">
        ...
        <span class="text-zinc-600">Editar</span>
    </div>

    <div class="bg-white rounded-xl border border-stone-200 shadow-sm p-6">
        <h2 class="text-base font-bold text-zinc-900 mb-5">Editar barbero</h2>
        ...
        <form method="POST" action="<?= url('barberos/actualizar') ?>" class="space-y-4">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            <input type="hidden" name="id" value="<?= (int)$barbero['id'] ?>">
            ...
            <div>
                ...
                <input type="text" name="descripcion"
                       value="<?= htmlspecialchars($barbero['descripcion'] ?? '') ?>"
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="<?= url('barberos/horario') ?>?id=<?= (int)$barbero['id'] ?>"
